...
describe('Admin routes access controls', () => {
  ...
  it('blocks non-admins from admin panel endpoints', async () => {
    ...
    const routes = [
      ...
      { method: 'GET', url: '/admin/pi-sync/health' },
      { method: 'POST', url: '/admin/pi-sync/run' },
      { method: 'POST', url: '/admin/pi-sync/sessions/session-1/run' },
      { method: 'POST', url: '/admin/pi-sync/anomalies/anomaly-1/backfill' },
      { method: 'POST', url: '/admin/pi-sync/anomalies/anomaly-1/ignore' },
